...
/**
 * This is the extension manager of the BugStoreFront extension.
 */
public class BugStoreFrontManager extends GeneratedBugStoreFrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BugStoreFrontManager.class.getName());
	 ...
	 */
	public static BugStoreFrontManager getInstance()
	{
		return (BugStoreFrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BugStoreFrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BugStoreFrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BugStoreFrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BugStoreFrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BugStoreFrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
