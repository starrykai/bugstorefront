 ...
 */
public class BugBackOfficeManager extends GeneratedBugBackOfficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BugBackOfficeManager.class.getName());
	 ...
	 */
	public static BugBackOfficeManager getInstance()
	{
		return (BugBackOfficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BugBackOfficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BugBackOfficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BugBackOfficeManager called.");
		}
	}
